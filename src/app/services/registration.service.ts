...
export class RegistrationService {
    ...
    registerUser(registerUserRequest: IRegisterUserRequest): Observable<IRegisterUserResponse> {
        return this.httpClient.post<IRegisterUserResponse>(this.environmentService.getEnvironment().backendUrl + this.registrationRoot + this.registerUserPath, registerUserRequest);
    }
